...
ResultSet ListaMedicamentos = c.smt.executeQuery("SELECT IDMedicamento, Nombre, Descripcion, CantidadInventario, FechaVencimiento, Precio  FROM medicamentos");
    ...
    <body>
        ...
        <div class="wrapper">
            <div class="wrap">
                ...
                <div class="boton">
                    <button type="button" class="btn btn-success btn-lg" data-toggle="modal" data-target="#agregarMedicamentoModal">AGREGAR MEDICAMENTO</button>
                </div>
                ...
                <div class="boton">
                    <form action="tu_pagina.jsp" method="GET" class="form-inline">
                        <div class="input-group">
                            <input type="text" name="searchTerm" class="form-control" placeholder="Buscar medicamento" value="<%= searchTerm%>">
                ...
                <!-- Tabla de medicamentos con imágenes -->
                <table class="table table-bordered" id="tablaDatos">
                    ...
                    <tbody id="tbodys">
                        <% while (ListaMedicamentos.next()) {%>
                        <tr>
                            <td class="text-center"><%= ListaMedicamentos.getInt("IDMedicamento")%></td>
                            <td><%= ListaMedicamentos.getString("Nombre")%></td>
                            <td><%= ListaMedicamentos.getString("Descripcion")%></td>
                            <td class="text-center"><%= ListaMedicamentos.getInt("CantidadInventario")%></td>
                            <td class="text-center"><%= ListaMedicamentos.getDouble("Precio")%></td>
